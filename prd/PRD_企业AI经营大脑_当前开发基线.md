...
> **版本**：v3.2 ｜ **状态**：当前开发真源 ｜ **日期**：2026-09-01
...
- 示例：点击“系统管理 / 系统设置”后，顶部显示“系统管理”，内容区显示“系统设置”。
...
| AI 获客 | 获客总览/获客计划/爆款追踪/AI 混剪/营销视频/数字人 | 按当前原型分别进入任务页；每页可从右侧入口查看页面 PRD |
...
| 系统管理 | 系统设置/成员管理/权限管理/平台账号/提示词管理/用量管理/日志与审计 | 企业基础信息、SaaS RBAC、渠道授权、Prompt 资产、额度与审计；旧 `settings/member/agent-center` 分别兼容跳转到 `system/members/prompts` |
