...
function loadPptModel() {
  ...
  return Function(`${source};return {PPT_CREATION_STAGES,createPptOutlineDraft,approvePptOutline,startApprovedPptGeneration,createPptGenerationTask,completePptGenerationTask,canDownloadPpt};`)();
}
